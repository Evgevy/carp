...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initPicSlider: function() { return /* binding */ initPicSlider; }
/* harmony export */ });
var slider = document.querySelector('[data-slider="pic"]');
var initPicSlider = function initPicSlider() {
  if (!slider) {
    return;
  }
  var swiper = new Swiper(slider, {
...
//                 // Для iOS используем requestAnimationFrame
//                 requestAnimationFrame(() => {
//                     const y = targetElement.getBoundingClientRect().top + window.pageYOffset;
//                     window.scrollTo({
//                         top: y,
//                         behavior: 'auto' // 'smooth' может не работать
//                     });
//                 });
//             }
//         });
...
var initScroll = function initScroll() {
  ...
  document.querySelectorAll('.main-nav__link').forEach(function (link) {
    link.addEventListener('click', function (e) {
      if (window.innerWidth <= 1023) {
        ...
        // Используем localStorage вместо sessionStorage для надежности
        localStorage.setItem('forceScrollTo', targetHref);

        // Перезагружаем страницу с якорем в URL
        window.location.href = window.location.pathname + targetHref;
      }
    });
  });
  ...
  var handleLoad = function handleLoad() {
    var targetHash = localStorage.getItem('forceScrollTo');
    if (targetHash) {
      localStorage.removeItem('forceScrollTo');
      var targetElement = document.querySelector(targetHash);
      if (targetElement) {
        // Двойная проверка для iOS
        var scrollToTarget = function scrollToTarget() {
          // Пытаемся использовать smooth scroll
          if ('scrollBehavior' in document.documentElement.style) {
            ...
            var y = targetElement.getBoundingClientRect().top + window.pageYOffset;
            window.scrollTo(0, y);
          }
        };
        ...
        // Вторая попытка через небольшой таймаут (для iOS)
  ...
  // Дублируем на DOMContentLoaded для быстрых загрузок
...
/* harmony import */ var _modules_init_marque__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./modules/init-marque */ "./js/modules/init-marque.js");
/* harmony import */ var _modules_init_pic_slider__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./modules/init-pic-slider */ "./js/modules/init-pic-slider.js");
/* harmony import */ var _modules_init_scroll__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./modules/init-scroll */ "./js/modules/init-scroll.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0,_modules_init_marque__WEBPACK_IMPORTED_MODULE_26__.initMarque)();
    (0,_modules_init_pic_slider__WEBPACK_IMPORTED_MODULE_27__.initPicSlider)();
    (0,_modules_init_scroll__WEBPACK_IMPORTED_MODULE_28__.initScroll)();
  });
});
