...
var initScroll = function initScroll() {
  // Проверяем мобильное viewport один раз при инициализации
  var isMobileView = window.innerWidth < 1023;
  var header = document.querySelector('.header');

  // Функция для плавного скролла с полифиллом
  var smoothScrollTo = function smoothScrollTo(targetElement) {
    if (!targetElement) return;
  ...
  // Находим все якорные ссылки в меню
  var anchorLinks = document.querySelectorAll('.main-nav__link[href^="#"]');
  ...
  // Обработчик начального скролла
  var handleInitialScroll = function handleInitialScroll() {
...
// Инициализация
document.addEventListener('DOMContentLoaded', function () {
  var scrollInstance = initScroll();
  scrollInstance.init();
});

// Реинициализация при ресайзе (с троттлингом)
var resizeTimeout;
